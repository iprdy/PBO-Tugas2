...
public class RouterController {
    ...
    //DELETE
    public static void handleDeleteRoomTypeByVillaId(String path, Response res) throws Exception {
        int rid = extractIdFromPath(path, 1);
        int vid = extractIdFromPath(path, 3);
        VillasController vc = new VillasController();
        ...
        ResponseController.sendJsonResponseWithMessage(
                "Berhasil menghapus roomtype dengan id " + rid + " di villa dengan id " + vid,
                oldRoomType,
                res
        );
    }
